...
const AboutUsScreen = () => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.description}>
        <Text style={styles.bold}>What We Offer:{'\n'}</Text>
        {'\n'} <Text style={styles.bold}>A World of Recipes:</Text>
        {'\n'} Explore a vast collection of mouthwatering recipes from around
        the globe, curated to suit every taste and occasion.{'\n'}
        {'\n'} <Text style={styles.bold}>Smart Cooking Solutions:</Text>
        {'\n'} Find recipes based on ingredients you have on hand, dietary
        preferences, or meal preferences, making meal planning a breeze.{'\n'}
        {'\n'} <Text style={styles.bold}>Step-by-Step Guidance:</Text>
        {'\n'} Follow easy-to-follow, step-by-step instructions with detailed
        photos and videos, ensuring your culinary creations turn out perfectly
        every time.
      </Text>
